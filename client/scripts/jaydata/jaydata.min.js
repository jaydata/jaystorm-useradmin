...
from:c},d,f,e,j)}function o(a){!l.white&&g.from!==a&&f("expected_a_at_b_c",g,g.value,a,g.from)}function z(a,b,c){if(a[b]!==c){f("expected_a_b",a,c,a[b]);return true}return false}function B(a,b,c){c=c||a.value;if(p===Y){l.safe&&f("adsafe_a",a,c);if(typeof Y[c]!=="string"){a.writeable=typeof P[c]==="boolean"?P[c]:true;a.funct=p;za[c]=a}b==="becoming"&&(b="var")}else if(typeof p[c]==="string")if(p[c]==="undef"){l.undef||f("used_before_a",a,c);b="var"}else f("already_defined",a,c);else{a.funct=p;a.writeable=
...
!x||x.open&&(a||true)}function G(a){var b,c;if(typeof a==="number")x={at:a,open:true,was:c};else if(x){c=x;b=a==="var"||g.line!==n.line&&a!=="statement";x={at:(b||a==="control"?c.at+l.indent:c.at)+(c.wrap?l.indent:0),mode:a,open:b,was:c};a==="var"&&b&&(ga=x)}else x={at:1,mode:"statement",open:true}}function v(a,b){if(a){if(x&&x.open){x.at=x.at-l.indent;y()}i(a,b)}if(x)x=x.was}function A(a,b){b=b||g;b.id!=="(end)"&&!l.white&&(n.line!==b.line||n.thru+1!==b.from)&&f("expected_space_a_b",b,n.value,b.value)}
function Q(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!l.white&&a.thru+1!==b.from)&&f("expected_space_a_b",b,a.value,b.value)}function w(a,b){a=a||n;b=b||g;(!l.white||t==="styleproperty"||t==="style")&&a.thru!==b.from&&a.line===b.line&&f("unexpected_space_a_b",b,a.value,b.value)}function D(a,b){a=a||n;b=b||g;b.id!=="(end)"&&(a.line!==b.line||!l.white&&a.thru!==b.from)&&f("unexpected_space_a_b",b,a.value,b.value)}function I(a,b){if(!l.white){a=a||n;b=b||g;a.thru===b.from&&a.line===b.line&&
f("missing_space_a_b",b,a.value,b.value)}}function C(){if(g.id!==",")j("expected_a_b",n.line,n.thru,",",g.value);else{l.white||D();i(",");m();I()}}function W(){if(g.id!==";")j("expected_a_b",n.line,n.thru,";",g.value);else{l.white||D();i(";");m();Lb[g.id]!==true&&I()}}function Ma(){if(g.value==="use strict"){na&&f("unnecessary_use");y();i();W();na=true;l.newcap=false;l.undef=false;return true}return false}function S(a,b){if(a===b)return true;if(Array.isArray(a)){if(Array.isArray(b)&&a.length===b.length){var c;
...
b.second.value&&b.second.id==="(string)";if(a.id==="["&&a.arity==="infix"&&b.id===".")return a.second.value===b.second.value&&a.second.id==="(string)"}return false}function r(a,b){var c;g.id==="(end)"&&k("unexpected_a",n,g.id);i();l.safe&&F[n.value]&&F[n.value]===za[n.value]&&g.id!=="("&&g.id!=="."&&f("adsafe",n);if(b){$a="anonymous";p["(verb)"]=n.value}if(b===true&&n.fud)c=n.fud();else{if(n.nud)c=n.nud();else{if(g.id==="(number)"&&n.id==="."){f("leading_decimal_a",n,g.value);i();return n}k("expected_identifier_a",
...
function bb(a){return(a=a.identifier&&F[a.value]||a)&&a.type}function K(a,b,c){var d="",e,j,g;if(typeof a!=="string"){j=a.identifier&&F[a.value]||a;a=j.type}g=b.identifier&&F[b.value]||b;e=g.type;if(a)e?a===e?d=a:l.type||f("type_inconsistency_a_b",c||b,a,e):g.type=d=a;else if(e){if(j)j.type=e;d=e}return d}function E(a,b){var c=L(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function ua(b,c,d){b=E(b);b.type=c;b.value=d;b.nud=a;return b}function db(a,b){return E(a,function(){typeof b===
...
g,a.value,g.value):fb.test(a.value+":")?f("url",a):p===Y&&k("unexpected_a",n);g.label=a}y();G("statement");if(a=r(0,true))if(a.arity==="statement")a.id==="switch"||a.block&&a.id!=="do"?I():W();else{a.id==="("?a.first.id==="new"&&f("bad_new"):!a.assign&&a.id!=="delete"&&a.id!=="++"&&a.id!=="--"&&f("assignment_function_expression",n);W()}v();F=b;return a}}function qa(){for(var a=[],b,c;g.postscript!==true;)if(g.id===";"){f("unexpected_a",g);W()}else{if(g.value==="use strict"){(!Ka||p!==Y||a.length>
0)&&f("function_strict");Ma()}if(b){f("unreachable_a_b",g,g.value,b.value);b=null}if(c=eb()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ea(a){var b,c=g,d=Ea,e=F,j=na;Ea=a;F=Object.create(F);I();if(g.id==="{"){i("{");G();!a&&!Ma()&&!j&&!l.sloppy&&p["(context)"]===Y&&f("missing_use_strict");b=qa();na=j;v("}",c);m()}else if(a){f("expected_a_b",g,"{",g.value);b=[eb()];b.disrupt=b[0].disrupt}else k("expected_a_b",g,"{",g.value);p["(verb)"]=null;F=e;Ea=d;a&&b.length===0&&f("empty_block");
...
b+J(a.first);break;case "case":case "infix":b=b+(J(a.first)+J(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(J(a.first)+J(a.second)+J(a.third))}return b}function Ra(a,b){var d=p,f=l,e=ha,j=F;p={"(name)":b||"'"+($a||"").replace(vb,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":F,"(token)":a};ha=e&&Object.create(e);l=Object.create(f);F=Object.create(j);Sa.push(p);(a.name=b)&&B(a,"function",b);a.writeable=false;var h=p,k;a:{var s=g,o=[];i("(");G();
m();w();if(g.id===")"){w();v(")",s);m();k=void 0}else for(;;){y();pa();o.push(n);B(n,l.unparam?"parameter":"unparam");if(g.id===",")C();else{w();v(")",s);m();k=o;break a}}}a.first=h["(params)"]=k;a.type="function";A();a.block=ea(false);p["(complexity)"]=J(a.block)+1;p=d;l=f;ha=e;F=j}function hb(){function a(){var b=g,c={};i("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);C()}g.id!=="(string)"&&f("expected_string_a");c[g.value]===true?f("duplicate_a"):g.value==="__proto__"?
f("dangling_a"):c[g.value]=true;i();i(":");hb();if(g.id!==",")break;C();if(g.id==="}"){f("unexpected_a",n);break}}i("}",b)}function b(){var a=g;i("[");if(g.id!=="]")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);C()}hb();if(g.id!==",")break;C();if(g.id==="]"){f("unexpected_a",n);break}}i("]",a)}switch(g.id){case "{":a();break;case "[":b();break;case "true":case "false":case "null":case "(number)":case "(string)":i();break;case "-":i("-");D();i("(number)");break;default:k("unexpected_a")}}
function ib(){if(g.identifier){i();return true}}function Ta(){if(g.id==="-"){i("-");D()}if(g.id==="(number)"){i("(number)");return true}}function jb(){if(g.id==="(string)"){i();return true}}function ja(){var a,b,c,d;if(g.identifier){d=g.value;if(d==="rgb"||d==="rgba"){i();c=g;i("(");for(a=0;a<3;a=a+1){a&&C();b=g.value;if(g.id!=="(string)"||b<0){f("expected_positive_a",g);i()}else{i();if(g.id==="%"){i("%");b>100&&f("expected_percent_a",n,b)}else b>255&&f("expected_small_a",n,b)}}if(d==="rgba"){C();
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&f("expected_fraction_a",g);i();if(g.id==="%"){f("unexpected_a");i("%")}}i(")",c);return true}if(Nb[g.value]===true){i();return true}}else if(g.id==="(color)"){i();return true}return false}function u(){if(g.id==="-"){i("-");D()}if(g.id==="(number)"){i();if(g.id!=="(string)"&&wb[g.value]===true){D();i()}else+n.value!==0&&f("expected_linear_a");return true}return false}function wa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":i();return true}else return u()}
...
g.id==="(end)")break a;g.id===","&&C()}t="styleproperty";if(g.id===";")W();else{i("{");yb();t="style";i("}")}}}function Ab(){for(;g.id==="@";){q();i("@");if(g.identifier)switch(g.value){case "import":i();if(!sa()){f("expected_a_b",g,"url",g.value);i()}W();break;case "media":for(i();;){(!g.identifier||Bb[g.value]===true)&&k("expected_media_a");i();if(g.id!==",")break;C()}i("{");zb();i("}");break;default:f("expected_at_a")}else f("expected_at_a")}zb()}var X,Ha,Ia,la,$a,Va,Ob={"<":true,"<=":true,"==":true,
...
q);default:if(t==="outer"&&l==="&"){e=e+1;for(m=m.slice(1);;){l=m.charAt(0);e=e+1;m=m.slice(1);if(l===";")break;l>="0"&&l<="9"||l>="a"&&l<="z"||l==="#"||s("bad_entity",i,h+k,e)}break}return c("(punctuator)",q)}}else{for(;m&&m<"!";)m=m.slice(1);if(m){if(t==="html")return c("(error)",m.charAt(0));s("unexpected_a",i,e,m.charAt(0))}}}}}}();Z["(identifier)"]={lbp:0,identifier:true,nud:function(){var a=this.value,b=F[a];if(typeof b!=="object"){b=P[a];if(typeof b==="boolean"){za[a]=b={value:a,writeable:b,
...
"boolean"||g.id==="(")break;if(Sb[c]===true){g.id==="."&&f("adsafe",b);break}if(g.id!=="."){f("adsafe",b);break}i(".");n.first=b;n.second=c;b=n;c=pa();typeof c==="string"&&Qa(c)}c==="length"&&K("number",b);return b},"",true);M("[",170,function(a,b){var c=bb(a),d;D(U,n);w();G();y();d=r(0);switch(bb(d)){case "number":d.id==="(number)"&&a.id==="arguments"&&f("use_param",a);c||K("array",a);break;case "string":if(d.id==="(string)"){if(l.safe&&(Pa[d.value]||d.value.charAt(0)==="_"||d.value.slice(-1)===
...
d):f("bad_type")}v("]",b);m();w(U,n);b.first=a;b.second=d;return b},"",true);O("[",function(){this.arity="prefix";this.first=[];this.type="array";for(G("array");g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);i(",");m()}if(g.id==="]")break;x.wrap=false;y();this.first.push(r(10));if(g.id===","){C();if(g.id==="]"&&!l.es5){f("unexpected_a",n);break}}else break}v("]",this);m();return this},170);aa("=");aa("+=","+");aa("-=","-");aa("*=","*");aa("/=","/").nud=function(){k("slash_equal")};aa("%=",
"%");aa("&=","&");aa("|=","|");aa("^=","^");aa("<<=","<<");aa(">>=",">>");aa(">>>=",">>>");O("{",function(){var a,b,c,d,e,j={};this.arity="prefix";this.first=[];this.type="object";for(G();g.id!=="}";){x.wrap=false;y();if(g.value==="get"&&q().id!==":"){l.es5||f("es5");a=g;i("get");Q();d=g;(b=gb())||k("missing_property");a.value="";Ra(a);p["(loopage)"]&&f("function_loop",a);(c=a.first)&&f("parameter_a_get_b",c[0],c[0].value,b);C();e=g;e.value="";I();y();i("set");Q();c=gb();b!==c&&k("expected_a_b",n,
b,c||g.value);Ra(e);c=e.first;!c||c.length!==1?k("parameter_set_a",e,"value"):c[0].value!=="value"&&k("expected_a_b",c[0],"value",c[0].value);d.first=[a,e]}else{d=g;b=gb();typeof b!=="string"&&k("missing_property");i(":");m();I();d.first=r(10)}this.first.push(d);j[b]===true&&f("duplicate_a",g,b);j[b]=true;Qa(b);if(g.id!==",")break;for(;;){C();if(g.id!==",")break;f("unexpected_a",g)}g.id==="}"&&!l.es5&&f("unexpected_a",n)}v("}",this);m();return this});R("{",function(){m();f("statement_block");this.arity=
...
g.identifier&&k("var_a_not");a.second=r(0);a.arity="infix";this.first.push(a);if(a.second.type)c.type=a.second.type}else this.first.push(c);p[b]==="becoming"&&(p[b]="unused");if(g.id!==",")break;C();x.wrap=false;if(ga&&g.line===n.line&&this.first.length===1){ga=null;x.open=false;x.at=x.at-l.indent}I();y()}ga=null;v();return this});R("function",function(){A();Ea&&f("function_block",n);var a=g,b=pa();B(a,"unction");w();Ra(this,b);g.id==="("&&g.line===n.line&&k("function_statement");this.arity="statement";
return this});O("function",function(){A();var a=pa();a?w():a="";Ra(this,a);p["(loopage)"]&&f("function_loop");this.arity="function";return this});R("if",function(){var a=g;A();i("(");G("control");m();w();y();this.arity="statement";this.first=da(ca(r(0)));w();v(")",a);m();A();this.block=ea(true);if(g.id==="else"){A();i("else");m();A();this["else"]=g.id==="if"||g.id==="switch"?eb(true):ea(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});R("try",function(){var a,b,c;
l.adsafe&&f("adsafe_a",this);A();this.arity="statement";this.block=ea(false);if(g.id==="catch"){A();i("catch");m();A();c=g;i("(");G("control");m();w();y();b=F;F=Object.create(b);this.first=a=g.value;g.identifier?B(g,"exception"):f("expected_identifier_a",g);i();w();v(")",c);m();A();this.second=ea(false);F=b}if(g.id==="finally"){m();A();i("finally");m();A();this.third=ea(false)}else this.second||k("expected_a_b",g,"catch",g.value);return this});Na("while",function(){A();var a=g;p["(breakage)"]=p["(breakage)"]+
1;p["(loopage)"]=p["(loopage)"]+1;i("(");G("control");m();w();y();this.arity="statement";this.first=ca(r(0));this.first.id!=="true"&&da(this.first,H.unexpected_a);w();v(")",a);m();A();this.block=ea(true);this.block.disrupt&&f("strange_loop",U);p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});E("with");Na("switch",function(){var a,b=g,c=true;p["(breakage)"]=p["(breakage)"]+1;A();i("(");m();w();G();this.arity="statement";this.first=da(ca(r(0)));w();v(")",b);m();A();i("{");
...
b.arity="case";y("case");i("default");m();D();i(":");m();I();b.second=qa();if(b.second&&b.second.length>0){a=b.second[b.second.length-1];if(c&&a.disrupt&&a.id!=="break")this.disrupt=true}this.second.push(b)}p["(breakage)"]=p["(breakage)"]-1;I();v("}",this);return this});R("debugger",function(){l.debug||f("unexpected_a",this);this.arity="statement";return this});Na("do",function(){p["(breakage)"]=p["(breakage)"]+1;p["(loopage)"]=p["(loopage)"]+1;A();this.arity="statement";this.block=ea(true);this.block.disrupt&&
f("strange_loop",U);A();i("while");m();var a=g;A();i("(");G();m();w();y();this.first=da(ca(r(0)),H.unexpected_a);w();v(")",a);m();p["(breakage)"]=p["(breakage)"]-1;p["(loopage)"]=p["(loopage)"]-1;return this});Na("for",function(){var a,b,c=false;a=g;var d;this.arity="statement";p["(breakage)"]=p["(breakage)"]+1;p["(loopage)"]=p["(loopage)"]+1;i("(");G("control");m();I(this,a);w();g.id==="var"&&k("move_var");y();if(q(0).id==="in"){b=g;switch(p[b.value]){case "unused":p[b.value]="var";break;case "closure":case "var":break;
...
"call"&&b.second[0].value===d.second.value&&b.second[1].value===d.first.value)}}c||f("for_if",this)}}else{if(g.id!==";"){y();for(this.first=[];;){this.first.push(r(0,"for"));if(g.id!==",")break;C()}}W();if(g.id!==";"){y();this.second=ca(r(0));this.second.id!=="true"&&da(this.second,H.unexpected_a)}W(n);g.id===";"&&k("expected_a_b",g,")",";");if(g.id!==")"){this.third=[];for(y();;){this.third.push(r(0,"for"));if(g.id!==",")break;C()}}w();v(")",a);m();A();a=ea(true)}a.disrupt&&f("strange_loop",U);this.block=
...
color:ja,content:["open-quote","close-quote","no-open-quote","no-close-quote",jb,sa,function(){if(g.identifier&&g.value==="counter"){i();i("(");i();if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}if(g.identifier&&g.value==="counters"){i();i("(");g.identifier||f("expected_name_a");i();if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");i()}if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");i()}i(")");return true}return false},function(){if(g.identifier&&
...
"table-column-group","table-footer-group","table-header-group","table-row","table-row-group"],"empty-cells":["show","hide"],"float":["left","none","right"],font:["caption","icon","menu","message-box","small-caption","status-bar",true,"font-size","font-style","font-weight","font-family"],"font-family":function(){for(;g.id!==";";){!ib()&&!jb()&&f("expected_name_a");if(g.id!==",")return true;C()}},"font-size":["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",u],"font-size-adjust":["none",
...
Ia=la=false;Va={};if(l.approved)for(c=0;c<l.approved.length;c=c+1)Va[l.approved[c]]=l.approved[c];else Va.test="test";Ya="";for(c=0;c<l.indent;c=c+1)Ya=Ya+" ";za=F={};Y=p={"(scope)":F,"(breakage)":0,"(loopage)":0};Sa=[p];Ca=false;Xa={};Ea=false;x=null;ma=false;Aa=[];ra={};Ka=false;ha=null;qb=true;rb=false;N=null;na=false;Ga=[];ga=null;La=0;t="";Ba.init(a);e();try{i();if(g.id==="(number)")k("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var m,o,s,q,B=l.white,r,w,v,A;t="html";T="";for(N=null;;){switch(g.value){case "<":t=
...
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&f("expected_a_b",g,">",g.value);f("bad_name_a")}l.white=false;I();m=g.value;l.white=B;i();!l.cap&&m!==m.toLowerCase()&&f("attribute_case_a",n);m=m.toLowerCase();T="";Object.prototype.hasOwnProperty.call(o,m)&&f("duplicate_a",n,m);if(m.slice(0,2)==="on"){l.on||f("html_handlers");t="scriptstring";i("=");r=g.id;r!=='"'&&r!=="'"&&k("expected_a_b",g,'"',g.value);T=r;A=l.white;l.white=true;i(r);Ma();qa();l.white=A;g.id!==r&&
...
0||c.indexOf("url")>=0){l.safe&&xb.test(j)&&k("bad_url",g,j);Ga.push(j)}else c==="for"?l.adsafe&&(X?j.slice(0,X.length)!==X?f("adsafe_prefix_a",g,X):/^[A-Z]+_[A-Z]+$/.test(j)||f("adsafe_bad_id"):f("adsafe_bad_id")):c==="name"&&l.adsafe&&j.indexOf("_")>=0&&f("adsafe_name_a",g,j)}c=q;j=o;h=void 0;var D=nb[c],C=u=void 0;rb=false;D||k(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(N.length>0){c==="html"&&k("unexpected_a",n,c);if(C=D.parent)C.indexOf(" "+N[N.length-1].name+
" ")<0&&k("tag_a_in_b",n,c,C);else if(!l.adsafe&&!l.fragment){h=N.length;do{h<=0&&k("tag_a_in_b",n,c,"body");h=h-1}while(N[h].name!=="body")}}switch(c){case "div":l.adsafe&&N.length===1&&!X&&f("adsafe_missing_id");break;case "script":t="script";i(">");j.lang&&f("lang",n);l.adsafe&&N.length!==1&&f("adsafe_placement",n);if(j.src){l.adsafe&&(!Ha||!Va[j.src])&&f("adsafe_source",n);j.type&&f("type",n)}else{G(g.from);y();Ma();Ia=true;u=qa();if(l.adsafe){la&&k("adsafe_script",n);(u.length!==1||z(u[0],"id",
"(")||z(u[0].first,"id",".")||z(u[0].first.first,"value","ADSAFE")||z(u[0].second[0],"value",X))&&k("adsafe_id_go");switch(u[0].first.second.value){case "id":(Ha||la||u[0].second.length!==1)&&k("adsafe_id",g);Ha=true;break;case "go":la&&k("adsafe_go");(u[0].second.length!==2||z(u[0].second[1],"id","function")||!u[0].second[1].first||u[0].second[1].first.length!==2||z(u[0].second[1].first[0],"value","dom")||z(u[0].second[1].first[1],"value","lib"))&&k("adsafe_go",g);la=true;break;default:k("adsafe_id_go")}}x=
...
a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return null;case a.Boolean:return false;default:return null}};this.registerType=function(a,e,h){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var j=[];j.push(a);a=j}for(j=0;j<a.length;j++){var z=a[j].split("."),y={};y.shortName=z[z.length-1];y.fullName=a[j];a[j]=y}z=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);
b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(z,e);for(var j=0,G=a.length;j<G;j++){y=a[j];"create"+y.shortName in f?console&&console.warn("warning: short names overlap:"+y.shortName+", Container.create"+y.shortName+" has not been updated"):f["create"+y.shortName]=typeof h==="function"?h:z;var v=d.indexOf(e);if(v==-1){v=d.push(e)-1;c[v]=y.fullName}y.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+y.fullName);b[y.fullName]=v}if(!e.name)e.name=
...
"."+a.getMilliseconds()}});$data.Geography=function(a,b){if(typeof a==="object"&&Array.isArray(a.coordinates)){this.longitude=a.coordinates[0];this.latitude=a.coordinates[1]}else{this.longitude=a;this.latitude=b}};$data.Container.registerType(["$data.Geography","Geography","geography","geo"],$data.Geography);$data.Geography.prototype.toJSON=function(){return{type:"Point",coordinates:[this.longitude,this.latitude]}};
(function(a){function b(){}function c(){}function d(){}function e(){}function h(){}function f(){}function j(){}function k(){}function s(){}function o(){}function z(){}function B(){}function q(){}function m(){}function i(){}a.Container.registerType("Edm.Boolean",b);a.Container.mapType(b,a.Boolean);a.Container.registerType("Edm.Binary",c);a.Container.mapType(c,a.Blob);a.Container.registerType("Edm.DateTime",d);a.Container.mapType(d,a.Date);a.Container.registerType("Edm.DateTimeOffset",e);a.Container.mapType(e,
a.Integer);a.Container.registerType("Edm.Time",h);a.Container.mapType(h,a.Integer);a.Container.registerType("Edm.Decimal",f);a.Container.mapType(f,a.Number);a.Container.registerType("Edm.Single",j);a.Container.mapType(j,a.Number);a.Container.registerType("Edm.Double",k);a.Container.mapType(k,a.Number);a.Container.registerType("Edm.Guid",s);a.Container.mapType(s,a.String);a.Container.registerType("Edm.Int16",o);a.Container.mapType(o,a.Integer);a.Container.registerType("Edm.Int32",z);a.Container.mapType(z,
...
$data.EntityState.Unchanged){j.skipSave=true;d.push(j.data)}else if(j.data.entityState==$data.EntityState.Modified&&j.data.changedProperties&&!j.data.changedProperties.some(function(a){a=k.PhysicalType.memberDefinitions.getMember(a.name);if(a.kind==$data.MemberTypes.navProperty){a=k.Associations[a.association];a=a.FromMultiplicity+a.ToMultiplicity;return a=="*0..1"||a=="0..11"}return true})){j.skipSave=true;d.push(j.data)}for(var s=[],o=k.PhysicalType.memberDefinitions.asArray(),z=0;z<o.length;z++){var B=
o[z];B.kind==$data.MemberTypes.navProperty&&s.push(B)}for(o=0;o<s.length;o++)for(var q=s[o],z=k.Associations[q.name],B=z.ToPropertyName,q=[].concat(j.data[q.name]),m=0;m<q.length;m++){var i=q[m];if(i){var V=i[B],ba=z.FromMultiplicity+z.ToMultiplicity;if(z.FromMultiplicity==="$$unbound")if(i instanceof $data.Array){j.dependentOn=j.dependentOn||[];for(V=0;V<i.length;V++)j.dependentOn.indexOf(i)<0&&i.skipSave!==true&&j.dependentOn.push(i)}else{j.dependentOn=j.dependentOn||[];j.dependentOn.indexOf(i)<
0&&i.skipSave!==true&&j.dependentOn.push(i)}else{switch(ba){case "*0..1":V?V instanceof Array?V.indexOf(j.data)==-1&&V.push(j.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):i[B]=[j.data];break;default:V?V!==j.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):i[B]=j.data}switch(ba){case "*0..1":case "0..11":j.dependentOn=j.dependentOn||[];j.dependentOn.indexOf(i)<0&&i.skipSave!==true&&j.dependentOn.push(i)}}if(!i.entityState)i.entityState=
...
[];v[o].modifyAll.push(d)}break;case $data.EntityState.Deleted:c=c|$data.Access.Delete;if(h.beforeDelete){if(!v[o].deleteAll)v[o].deleteAll=[];v[o].deleteAll.push(d)}}}}var A=function(a){if(a){Q="async";b.length=0}b.length?G.storageProvider.saveChanges({success:function(){G._postProcessSavedItems(e,b)},error:e.error},b):Q?e.error(new Exception("Cancelled event in "+Q,"CancelEvent")):e.success(0)},Q,w=Object.getOwnPropertyNames(v),f=0,D=["beforeUpdate","beforeDelete","beforeCreate"],I={beforeCreate:"createAll",
beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},C=function(a){if(a){Q="async";b.length=0;A(a)}else{var c=G._entitySetReferences[w[f]],d=D.pop();if(a=v[w[f]][I[d]]){for(var e=[],h=0;h<a.length;h++)e.push(a[h].data);if(!D.length){D=["beforeUpdate","beforeDelete","beforeCreate"];f++}h=c[d].call(G,e);if(typeof h==="function")h.call(G,f<w.length&&!Q?C:A,e);else if(h===false){Q=c.name+"."+d;for(c=0;c<a.length;c++){d=b.indexOf(a[c]);b.splice(d,1)}A()}else f<w.length&&!Q?C():A()}else{if(!D.length){D=["beforeUpdate",
"beforeDelete","beforeCreate"];f++}f<w.length&&!Q?C():A()}}};this.user&&this.checkPermission?this.checkPermission(c,this.user,w,{success:function(){f<w.length?C():A()},error:e.error}):f<w.length?C():A();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);for(var c={},d=this,e=0;e<b.length;e++){var h=b[e],f=h.data.entityState;h.data.entityState=
