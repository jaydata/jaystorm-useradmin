...
b:Math.floor(b/ya.length*100)})};}function f(a,b,c,d,f,e){var i,k,b=b||g;k=b.line||0;i=b.from||0;a={id:"(error)",raw:H[a]||a,evidence:ya[k-1]||"",line:k,character:i,a:c||b.value,b:d,c:f,d:e};a.reason=a.raw.supplant(a);JAYLINT.errors.push(a);l.passfail&&h(H.stopping,k,i);La=La+1;La>=l.maxerr&&h(H.too_many,k,i);return a}function i(a,b,c,d,e,i,g){return f(a,{line:b,from:c},d,e,i,g)}function k(a,b,c,d,e,i){a=f(a,b,c,d,e,i);h(H.stopping,a.line,a.character)}function s(a,b,c,d,f,e,i){return k(a,{line:b,
from:c},d,f,e,i)}function o(a){!l.white&&g.from!==a&&f("expected_a_at_b_c",g,g.value,a,g.from)}function z(a,b,c){if(a[b]!==c){f("expected_a_b",a,c,a[b]);return true}return false}function B(a,b,c){c=c||a.value;if(p===Y){l.safe&&f("adsafe_a",a,c);if(typeof Y[c]!=="string"){a.writeable=typeof P[c]==="boolean"?P[c]:true;a.funct=p;za[c]=a}b==="becoming"&&(b="var")}else if(typeof p[c]==="string")if(p[c]==="undef"){l.undef||f("used_before_a",a,c);b="var"}else f("already_defined",a,c);else{a.funct=p;a.writeable=
...
false:k("unexpected_a");if(a==="adsafe"){l.adsafe=l.safe=true;V()}else a==="safe"&&V()}j();g.id===","&&j(",")}e();break;case "/*globals":case "/*global":l.safe&&f("adsafe_a",this);a:for(var c;;){if(g.id!=="(string)"&&!g.identifier)break a;a=g.value;j();c=false;if(g.id===":"){j(":");switch(g.id){case "true":c=P[a]!==false;j("true");break;case "false":j("false");break;default:k("unexpected_a")}}P[a]=c;if(g.id!==",")break a;j(",")}break;default:k("unpexpected_a",this)}Ca=b;j("*/")}function y(a){g.edge=
...
f("missing_space_a_b",b,a.value,b.value)}}function C(){if(g.id!==",")i("expected_a_b",n.line,n.thru,",",g.value);else{l.white||D();j(",");m();I()}}function W(){if(g.id!==";")i("expected_a_b",n.line,n.thru,";",g.value);else{l.white||D();j(";");m();Lb[g.id]!==true&&I()}}function Ma(){if(g.value==="use strict"){na&&f("unnecessary_use");y();j();W();na=true;l.newcap=false;l.undef=false;return true}return false}function S(a,b){if(a===b)return true;if(Array.isArray(a)){if(Array.isArray(b)&&a.length===b.length){var c;
...
n,n.id)}for(;a<g.lbp;){j();n.led?c=n.led(c):k("expected_operator_a",n,n.id)}}return c}function Da(a,b){var c=Z[a];if(!c||typeof c!=="object")Z[a]=c={id:a,lbp:b,value:a};return c}function L(a){return Da(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Da(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;b.value=a;return oa(b)}function R(a,b){var c=L(a);c.identifier=c.reserved=true;c.fud=b;return c}function Na(a,b){R(a,b).labeled=true}function Oa(a,b){R(a,b).disrupt=true}function sb(a){var b=
...
function bb(a){return(a=a.identifier&&F[a.value]||a)&&a.type}function K(a,b,c){var d="",e,i,g;if(typeof a!=="string"){i=a.identifier&&F[a.value]||a;a=i.type}g=b.identifier&&F[b.value]||b;e=g.type;if(a)e?a===e?d=a:l.type||f("type_inconsistency_a_b",c||b,a,e):g.type=d=a;else if(e){if(i)i.type=e;d=e}return d}function E(a,b){var c=L(a);c.identifier=c.reserved=true;if(typeof b==="function")c.nud=b;return c}function ua(b,c,d){b=E(b);b.type=c;b.value=d;b.nud=a;return b}function db(a,b){return E(a,function(){typeof b===
...
0)&&f("function_strict");Ma()}if(b){f("unreachable_a_b",g,g.value,b.value);b=null}if(c=eb()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ea(a){var b,c=g,d=Ea,e=F,i=na;Ea=a;F=Object.create(F);I();if(g.id==="{"){j("{");G();!a&&!Ma()&&!i&&!l.sloppy&&p["(context)"]===Y&&f("missing_use_strict");b=qa();na=i;u("}",c);m()}else if(a){f("expected_a_b",g,"{",g.value);b=[eb()];b.disrupt=b[0].disrupt}else k("expected_a_b",g,"{",g.value);p["(verb)"]=null;F=e;Ea=d;a&&b.length===0&&f("empty_block");
return b}function Qa(a){ha&&typeof ha[a]!=="boolean"&&f("unexpected_property_a",n,a);ra[a]=typeof ra[a]==="number"?ra[a]+1:1}function gb(){var a=pa(true);if(!a)if(g.id==="(string)"){a=g.value;l.safe&&(Pa[a]?f("adsafe_a"):(a.charAt(0)==="_"||a.charAt(a.length-1)==="_")&&f("dangling_a"));j()}else if(g.id==="(number)"){a=g.value.toString();j()}return a}function J(a){var b=0;if(a)if(Array.isArray(a))a.forEach(function(a){b=b+J(a)});else switch(a.arity){case "statement":switch(a.id){case "if":b=b+(J(a.first)+
...
b+J(a.first);break;case "case":case "infix":b=b+(J(a.first)+J(a.second));if(a.id==="&&"||a.id==="||")b=b+1;break;case "ternary":b=b+(J(a.first)+J(a.second)+J(a.third))}return b}function Ra(a,b){var d=p,f=l,e=ha,i=F;p={"(name)":b||"'"+($a||"").replace(vb,c)+"'","(line)":g.line,"(context)":d,"(breakage)":0,"(loopage)":0,"(scope)":F,"(token)":a};ha=e&&Object.create(e);l=Object.create(f);F=Object.create(i);Sa.push(p);(a.name=b)&&B(a,"function",b);a.writeable=false;var h=p,k;a:{var s=g,o=[];j("(");G();
m();x();if(g.id===")"){x();u(")",s);m();k=void 0}else for(;;){y();pa();o.push(n);B(n,l.unparam?"parameter":"unparam");if(g.id===",")C();else{x();u(")",s);m();k=o;break a}}}a.first=h["(params)"]=k;a.type="function";A();a.block=ea(false);p["(complexity)"]=J(a.block)+1;p=d;l=f;ha=e;F=i}function hb(){function a(){var b=g,c={};j("{");if(g.id!=="}")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);C()}g.id!=="(string)"&&f("expected_string_a");c[g.value]===true?f("duplicate_a"):g.value==="__proto__"?
f("dangling_a"):c[g.value]=true;j();j(":");hb();if(g.id!==",")break;C();if(g.id==="}"){f("unexpected_a",n);break}}j("}",b)}function b(){var a=g;j("[");if(g.id!=="]")for(;g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);C()}hb();if(g.id!==",")break;C();if(g.id==="]"){f("unexpected_a",n);break}}j("]",a)}switch(g.id){case "{":a();break;case "[":b();break;case "true":case "false":case "null":case "(number)":case "(string)":j();break;case "-":j("-");D();j("(number)");break;default:k("unexpected_a")}}
function ib(){if(g.identifier){j();return true}}function Ta(){if(g.id==="-"){j("-");D()}if(g.id==="(number)"){j("(number)");return true}}function jb(){if(g.id==="(string)"){j();return true}}function ja(){var a,b,c,d;if(g.identifier){d=g.value;if(d==="rgb"||d==="rgba"){j();c=g;j("(");for(a=0;a<3;a=a+1){a&&C();b=g.value;if(g.id!=="(string)"||b<0){f("expected_positive_a",g);j()}else{j();if(g.id==="%"){j("%");b>100&&f("expected_percent_a",n,b)}else b>255&&f("expected_small_a",n,b)}}if(d==="rgba"){C();
b=+g.value;(g.id!=="(string)"||b<0||b>1)&&f("expected_fraction_a",g);j();if(g.id==="%"){f("unexpected_a");j("%")}}j(")",c);return true}if(Nb[g.value]===true){j();return true}}else if(g.id==="(color)"){j();return true}return false}function v(){if(g.id==="-"){j("-");D()}if(g.id==="(number)"){j();if(g.id!=="(string)"&&wb[g.value]===true){D();j()}else+n.value!==0&&f("expected_linear_a");return true}return false}function wa(){if(g.identifier)switch(g.value){case "thin":case "medium":case "thick":j();return true}else return v()}
function Fa(){if(g.identifier){if(g.value==="auto"){j();return true}}else return v()}function sa(){var a,b;if(g.identifier&&g.value==="url"){g=Ba.range("(",")");b=g.value;a=b.charAt(0);if(a==='"'||a==="'")if(b.slice(-1)!==a)f("bad_url");else{b=b.slice(1,-1);b.indexOf(a)>=0&&f("bad_url")}b||f("missing_url");l.safe&&xb.test(b)&&k("adsafe_a",g,b);Ga.push(b);j();return true}return false}function kb(a){var b=0,c,d,f,e=0;switch(typeof a){case "function":return a();case "string":if(g.identifier&&g.value===
a){j();return true}return false}for(;;){if(b>=a.length)return false;f=a[b];b=b+1;if(typeof f==="boolean")break;else if(typeof f==="number"){c=f;f=a[b];b=b+1}else c=1;for(d=false;c>0;)if(kb(f)){d=true;c=c-1}else break;if(d)return true}e=b;for(c=[];;){f=false;for(b=e;b<a.length;b=b+1)if(!c[b]&&kb(Ua[a[b]])){f=d=true;c[b]=true;break}if(!f)return d}}function yb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){f("unexpected_a");W()}for(a=void 0;g.id==="*"||g.id==="#"||
g.value==="_";){l.css||f("unexpected_a");j()}if(g.id==="-"){l.css||f("unexpected_a");j("-");g.identifier||f("expected_nonstandard_style_attribute");j();a=lb}else{if(g.identifier)if(Object.prototype.hasOwnProperty.call(Ua,g.value))a=Ua[g.value];else{a=lb;l.css||f("unrecognized_style_attribute_a")}else f("expected_style_attribute");j()}j(":");if(g.identifier&&g.value==="inherit")j();else if(!kb(a)){f("unexpected_a");j()}if(g.id==="!"){j("!");D();g.identifier&&g.value==="important"?j():f("expected_a_b",
g,"important",g.value)}g.id==="}"||g.id===T?f("expected_a_b",g,";",g.value):W()}}function mb(){if(g.identifier){Object.prototype.hasOwnProperty.call(nb,l.cap?g.value.toLowerCase():g.value)||f("expected_tagname_a");j()}else switch(g.id){case ">":case "+":j();mb();break;case ":":j(":");switch(g.value){case "active":case "after":case "before":case "checked":case "disabled":case "empty":case "enabled":case "first-child":case "first-letter":case "first-line":case "first-of-type":case "focus":case "hover":case "last-child":case "last-of-type":case "link":case "only-of-type":case "root":case "target":case "visited":j();
break;case "lang":j();j("(");g.identifier||f("expected_lang_a");j(")");break;case "nth-child":case "nth-last-child":case "nth-last-of-type":case "nth-of-type":j();j("(");if(g.id==="(number)"){j();if(g.value==="n"&&g.identifier){D();j();if(g.id==="+"){D();j("+");D();j("(number)")}}}else g.identifier&&(g.value==="odd"||g.value==="even")?j():f("unexpected_a");j(")");break;case "not":j();j("(");g.id===":"&&q(0).value==="not"&&f("not");mb();j(")");break;default:f("expected_pseudo_a")}break;case "#":j("#");
g.identifier||f("expected_id_a");j();break;case "*":j("*");break;case ".":j(".");g.identifier||f("expected_class_a");j();break;case "[":j("[");g.identifier||f("expected_attribute_a");j();if(g.id==="="||g.value==="~="||g.value==="$="||g.value==="|="||g.id==="*="||g.id==="^="){j();g.id!=="(string)"&&f("expected_string_a");j()}j("]");break;default:k("expected_selector_a")}}function zb(){for(;g.id!=="</"&&g.id!=="(end)";){a:for(g.id==="{"&&f("expected_style_pattern");;){mb();if(g.id==="</"||g.id==="{"||
g.id==="(end)")break a;g.id===","&&C()}t="styleproperty";if(g.id===";")W();else{j("{");yb();t="style";j("}")}}}function Ab(){for(;g.id==="@";){q();j("@");if(g.identifier)switch(g.value){case "import":j();if(!sa()){f("expected_a_b",g,"url",g.value);j()}W();break;case "media":for(j();;){(!g.identifier||Bb[g.value]===true)&&k("expected_media_a");j();if(g.id!==",")break;C()}j("{");zb();j("}");break;default:f("expected_at_a")}else f("expected_at_a")}zb()}var X,Ha,Ia,la,$a,Va,Ob={"<":true,"<=":true,"==":true,
...
tt:{},u:{},ul:{},"var":{},video:{}},Xa,Ea,w,fa,ma,Ba,ya,Aa,ra,Jb={Buffer:false,clearInterval:false,clearTimeout:false,console:false,exports:false,global:false,module:false,process:false,querystring:false,require:false,setInterval:false,setTimeout:false,__dirname:false,__filename:false},Ka,Mb={indexOf:true,lastIndexOf:true,search:true},g,ta,l,P,qb,U,ha,Qb={g:true,i:true,m:true},Fb={defineClass:false,deserialize:false,gc:false,help:false,load:false,loadClass:false,print:false,quit:false,readFile:false,
readUrl:false,runCommand:false,seal:false,serialize:false,spawn:false,sync:false,toint32:false,version:false},F,Lb={";":true,'"':true,"'":true,")":true},rb,N,Rb={Array:false,Boolean:false,Date:false,decodeURI:false,decodeURIComponent:false,encodeURI:false,encodeURIComponent:false,Error:false,eval:false,EvalError:false,Function:false,isFinite:false,isNaN:false,JSON:false,Math:false,Number:false,Object:false,parseInt:false,parseFloat:false,RangeError:false,ReferenceError:false,RegExp:false,String:false,
...
i("unexpected_comment",d,e):t==="script"&&/<\//i.test(m)?i("unexpected_a",d,e,"</"):l.safe&&Tb.test(b)&&i("dangerous_comment",d,f);ta.comments?ta.comments.push(c):ta.comments=[c];JAYLINT.comments.push(c)}function b(){var a;if(j>=ya.length)return false;e=1;m=ya[j];j=j+1;a=m.search(/ \t/);a>=0&&i("mixed",j,a+1);m=m.replace(/\t/g,Ya);a=m.search(Wb);a>=0&&i("unsafe",j,a);l.maxlen&&l.maxlen<m.length&&i("too_long",j,m.length);return true}function c(a,b,d){var f;(a==="(string)"||a==="(range)")&&fb.test(b)&&
i("url",j,h);f=Object.create(Z[a==="(punctuator)"||a==="(identifier)"&&Object.prototype.hasOwnProperty.call(Z,b)?b:a]||Z["(error)"]);if(a==="(identifier)"){f.identifier=true;b==="__iterator__"||b==="__proto__"?s("reserved_a",j,h,b):!l.nomen&&(b.charAt(0)==="_"||b.charAt(b.length-1)==="_")&&i("dangling_a",j,h,b)}if(b!==void 0)f.value=b;if(d)f.quote=d;f.line=j;f.from=h;f.thru=e;f.prev=ta;qb=(a=f.id)&&("(,=:[!&|?{};".indexOf(a.charAt(a.length-1))>=0||a==="return");return ta=ta.next=f}function d(a){function f(a){var b=
parseInt(m.substr(k+1,a),16);k=k+a;b>=32&&b<=126&&b!==34&&b!==92&&b!==39&&i("unexpected_a",j,e,"\\");e=e+a;g=String.fromCharCode(b)}var g,k,Za="";ma&&a!=='"'&&i("expected_a",j,e,'"');if(T===a||t==="scriptstring"&&!T)return c("(punctuator)",a);for(k=0;;){for(;k>=m.length;){k=0;(t!=="html"||!b())&&s("unclosed",j,h)}g=m.charAt(k);if(g===a){e=e+1;m=m.slice(k+1);return c("(string)",Za,a)}if(g<" "){if(g==="\n"||g==="\r")break;i("control_a",j,e+o,m.slice(0,o))}else if(g===T)i("bad_html",j,e+k);else if(g===
"<")l.safe&&t==="html"?i("adsafe_a",j,e+o,g):m.charAt(o+1)==="/"&&(t||l.safe)?i("expected_a_b",j,e,"<\\/","</"):m.charAt(o+1)==="!"&&(t||l.safe)&&i("unexpected_a",j,e,"<!");else if(g==="\\")if(t==="html")l.safe&&i("adsafe_a",j,e+o,g);else if(t==="styleproperty"){k=k+1;e=e+1;g=m.charAt(k);g!==a&&i("unexpected_a",j,e,"\\")}else{k=k+1;e=e+1;g=m.charAt(k);switch(g){case "":l.es5||i("es5",j,e);b();k=-1;break;case T:i("bad_html",j,e+k);break;case "'":ma&&i("unexpected_a",j,e,"\\'");break;case "u":f(4);
break;case "v":ma&&i("unexpected_a",j,e,"\\v");g="\v";break;case "x":ma&&i("unexpected_a",j,e,"\\x");f(2);break;default:g=Pb[g];typeof g!=="string"&&i("unexpected_a",j,e,"\\")}}Za=Za+g;e=e+1;k=k+1}}function f(){for(var a,b,d=0,k=0;;){a=true;g=m.charAt(k);k=k+1;switch(g){case "":s("unclosed_regexp",j,h);return;case "/":d>0&&i("unescaped_a",j,h+k,"/");g=m.slice(0,k-1);for(d=Object.create(Qb);d[m.charAt(k)]===true;){d[m.charAt(k)]=false;k=k+1}m.charAt(k).isAlpha()&&s("unexpected_a",j,h,m.charAt(k));
...
L("--\>");oa(L("}"));L(")");L("]");oa(L('"'));oa(L("'"));L(";");L(":");L(",");L("#");L("@");L("*/");oa(E("case"));E("catch");oa(E("default"));E("else");E("finally");db("arguments",function(a){na&&p===Y?f("strict",a):l.safe&&f("adsafe",a)});db("eval",function(a){l.safe&&f("adsafe",a)});ua("false","boolean",false);ua("Infinity","number",Infinity);ua("NaN","number",NaN);ua("null","",null);db("this",function(a){na&&(p["(statement)"]&&p["(name)"].charAt(0)>"Z"||p===Y)?f("strict",a):l.safe&&f("adsafe",
a)});ua("true","boolean",true);ua("undefined","",void 0);M("?",30,function(a,b){b.first=da(ca(a));b.second=r(0);I();var c=g;j(":");m();I();b.third=r(10);b.arity="ternary";b.type=K(b.second,b.third);S(b.second,b.third)?f("weird_ternary",c):S(b.first,b.second)&&f("use_or",b);return b});M("||",40,function(a,b){function c(a){a.id==="&&"&&!a.paren&&f("and",a);return a}b.first=c(da(ca(a)));b.second=c(ca(r(40)));S(b.first,b.second)&&f("weird_condition",b);return b});M("&&",50,function(a,b){b.first=da(ca(a));
...
c);if(a.id===c.id&&a.id==="(number)"){a.value=a.value%c.value;a.thru=c.thru;m(c);m(b);return a}b.first=a;b.second=c;return b},"number");ub("++");O("++");ub("--");O("--");O("delete",function(){A();var a=r(0);(!a||a.id!=="."&&a.id!=="[")&&f("deleted");this.first=a;return this});O("~",function(){D();l.bitwise||f("unexpected_a",this);r(150);return this},"number");O("!",function(){D();this.first=da(r(150));this.arity="prefix";Ob[this.first.id]===true&&f("confusing_a",this);return this},"boolean");O("typeof",
...
a)})}else(a.second.value==="toString"||a.second.value==="stringify")&&K("string",b);else a.identifier&&a.value==="String"&&K("string",b);return b},"",true);O("(",function(){G("expression");m();x();y();if(g.id==="function")g.immed=true;var a=r(0);a.paren=true;x();u(")",this);m();a.id==="function"&&(g.id==="("?f("move_invocation"):f("bad_wrap",this));return a});M(".",170,function(a,b){x(U,n);x();var c=pa();typeof c==="string"&&Qa(c);b.first=a;b.second=n;if(a&&a.value==="arguments"&&(c==="callee"||c===
...
"boolean"||g.id==="(")break;if(Sb[c]===true){g.id==="."&&f("adsafe",b);break}if(g.id!=="."){f("adsafe",b);break}j(".");n.first=b;n.second=c;b=n;c=pa();typeof c==="string"&&Qa(c)}c==="length"&&K("number",b);return b},"",true);M("[",170,function(a,b){var c=bb(a),d;D(U,n);x();G();y();d=r(0);switch(bb(d)){case "number":d.id==="(number)"&&a.id==="arguments"&&f("use_param",a);c||K("array",a);break;case "string":if(d.id==="(string)"){if(l.safe&&(Pa[d.value]||d.value.charAt(0)==="_"||d.value.slice(-1)===
...
d):f("bad_type")}u("]",b);m();x(U,n);b.first=a;b.second=d;return b},"",true);O("[",function(){this.arity="prefix";this.first=[];this.type="array";for(G("array");g.id!=="(end)";){for(;g.id===",";){f("unexpected_a",g);j(",");m()}if(g.id==="]")break;w.wrap=false;y();this.first.push(r(10));if(g.id===","){C();if(g.id==="]"&&!l.es5){f("unexpected_a",n);break}}else break}u("]",this);m();return this},170);aa("=");aa("+=","+");aa("-=","-");aa("*=","*");aa("/=","/").nud=function(){k("slash_equal")};aa("%=",
"%");aa("&=","&");aa("|=","|");aa("^=","^");aa("<<=","<<");aa(">>=",">>");aa(">>>=",">>>");O("{",function(){var a,b,c,d,e,i={};this.arity="prefix";this.first=[];this.type="object";for(G();g.id!=="}";){w.wrap=false;y();if(g.value==="get"&&q().id!==":"){l.es5||f("es5");a=g;j("get");Q();d=g;(b=gb())||k("missing_property");a.value="";Ra(a);p["(loopage)"]&&f("function_loop",a);(c=a.first)&&f("parameter_a_get_b",c[0],c[0].value,b);C();e=g;e.value="";I();y();j("set");Q();c=gb();b!==c&&k("expected_a_b",n,
b,c||g.value);Ra(e);c=e.first;!c||c.length!==1?k("parameter_set_a",e,"value"):c[0].value!=="value"&&k("expected_a_b",c[0],"value",c[0].value);d.first=[a,e]}else{d=g;b=gb();typeof b!=="string"&&k("missing_property");j(":");m();I();d.first=r(10)}this.first.push(d);i[b]===true&&f("duplicate_a",g,b);i[b]=true;Qa(b);if(g.id!==",")break;for(;;){C();if(g.id!==",")break;f("unexpected_a",g)}g.id==="}"&&!l.es5&&f("unexpected_a",n)}u("}",this);m();return this});R("{",function(){m();f("statement_block");this.arity=
...
return this});O("function",function(){A();var a=pa();a?x():a="";Ra(this,a);p["(loopage)"]&&f("function_loop");this.arity="function";return this});R("if",function(){var a=g;A();j("(");G("control");m();x();y();this.arity="statement";this.first=da(ca(r(0)));x();u(")",a);m();A();this.block=ea(true);if(g.id==="else"){A();j("else");m();A();this["else"]=g.id==="if"||g.id==="switch"?eb(true):ea(true);if(this["else"].disrupt&&this.block.disrupt)this.disrupt=true}return this});R("try",function(){var a,b,c;
...
"call"&&b.second[0].value===d.second.value&&b.second[1].value===d.first.value)}}c||f("for_if",this)}}else{if(g.id!==";"){y();for(this.first=[];;){this.first.push(r(0,"for"));if(g.id!==",")break;C()}}W();if(g.id!==";"){y();this.second=ca(r(0));this.second.id!=="true"&&da(this.second,H.unexpected_a)}W(n);g.id===";"&&k("expected_a_b",g,")",";");if(g.id!==")"){this.third=[];for(y();;){this.third.push(r(0,"for"));if(g.id!==",")break;C()}}x();u(")",a);m();A();a=ea(true)}a.disrupt&&f("strange_loop",U);this.block=
...
E("public");E("static");lb=[sa,function(){for(;;)if(g.identifier)switch(g.value.toLowerCase()){case "url":sa();break;case "expression":f("unexpected_a");j();break;default:j()}else{if(g.id===";"||g.id==="!"||g.id==="(end)"||g.id==="}")return true;j()}}];xa=["none","dashed","dotted","double","groove","hidden","inset","outset","ridge","solid"];pb=["auto","always","avoid","left","right"];Bb={all:true,braille:true,embossed:true,handheld:true,print:true,projection:true,screen:true,speech:true,tty:true,
...
color:ja,content:["open-quote","close-quote","no-open-quote","no-close-quote",jb,sa,function(){if(g.identifier&&g.value==="counter"){j();j("(");j();if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");j()}j(")");return true}if(g.identifier&&g.value==="counters"){j();j("(");g.identifier||f("expected_name_a");j();if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");j()}if(g.id===","){C();g.id!=="(string)"&&f("expected_string_a");j()}j(")");return true}return false},function(){if(g.identifier&&
g.value==="attr"){j();j("(");g.identifier||f("expected_name_a");j();j(")");return true}return false}],"counter-increment":[ib,"none"],"counter-reset":[ib,"none"],cursor:[sa,"auto","crosshair","default","e-resize","help","move","n-resize","ne-resize","nw-resize","pointer","s-resize","se-resize","sw-resize","w-resize","text","wait"],direction:["ltr","rtl"],display:["block","compact","inline","inline-block","inline-table","list-item","marker","none","run-in","table","table-caption","table-cell","table-column",
"table-column-group","table-footer-group","table-header-group","table-row","table-row-group"],"empty-cells":["show","hide"],"float":["left","none","right"],font:["caption","icon","menu","message-box","small-caption","status-bar",true,"font-size","font-style","font-weight","font-family"],"font-family":function(){for(;g.id!==";";){!ib()&&!jb()&&f("expected_name_a");if(g.id!==",")return true;C()}},"font-size":["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",v],"font-size-adjust":["none",
Ta],"font-stretch":["normal","wider","narrower","ultra-condensed","extra-condensed","condensed","semi-condensed","semi-expanded","expanded","extra-expanded"],"font-style":["normal","italic","oblique"],"font-variant":["normal","small-caps"],"font-weight":["normal","bold","bolder","lighter",Ta],height:[v,"auto"],left:[v,"auto"],"letter-spacing":["normal",v],"line-height":["normal",function(){if(g.id==="-"){j("-");D()}if(g.id==="(number)"){j();if(g.id!=="(string)"&&wb[g.value]===true){D();j()}return true}return false}],
...
"max-height":[v,"none"],"max-width":[v,"none"],"min-height":v,"min-width":v,opacity:Ta,outline:[true,"outline-color","outline-style","outline-width"],"outline-color":["invert",ja],"outline-style":["dashed","dotted","double","groove","inset","none","outset","ridge","solid"],"outline-width":wa,overflow:Wa,"overflow-x":Wa,"overflow-y":Wa,padding:[4,v],"padding-bottom":v,"padding-left":v,"padding-right":v,"padding-top":v,"page-break-after":pb,"page-break-before":pb,position:["absolute","fixed","relative",
"static"],quotes:[8,jb],right:[v,"auto"],"table-layout":["auto","fixed"],"text-align":["center","justify","left","right"],"text-decoration":["none","underline","overline","line-through","blink"],"text-indent":v,"text-shadow":["none",4,[ja,v]],"text-transform":["capitalize","uppercase","lowercase","none"],top:[v,"auto"],"unicode-bidi":["normal","embed","bidi-override"],"vertical-align":["baseline","bottom","sub","super","top","text-top","middle","text-bottom",v],visibility:["visible","hidden","collapse"],
"white-space":["normal","nowrap","pre","pre-line","pre-wrap","inherit"],width:[v,"auto"],"word-spacing":["normal",v],"word-wrap":["break-word","normal"],"z-index":["auto",Ta]};fa=function(a,b){var c,i,h;JAYLINT.comments=[];JAYLINT.errors=[];JAYLINT.tree="";ob=ta=U=n=g=Object.create(Z["(begin)"]);P={};d(Rb);if(b){l=Object.create(b);if(i=l.predef)if(Array.isArray(i))for(c=0;c<i.length;c=c+1)P[i[c]]=true;else typeof i==="object"&&d(i);V()}else l={};l.indent=+l.indent||0;l.maxerr=l.maxerr||50;X="";Ha=
Ia=la=false;Va={};if(l.approved)for(c=0;c<l.approved.length;c=c+1)Va[l.approved[c]]=l.approved[c];else Va.test="test";Ya="";for(c=0;c<l.indent;c=c+1)Ya=Ya+" ";za=F={};Y=p={"(scope)":F,"(breakage)":0,"(loopage)":0};Sa=[p];Ca=false;Xa={};Ea=false;w=null;ma=false;Aa=[];ra={};Ka=false;ha=null;qb=true;rb=false;N=null;na=false;Ga=[];ga=null;La=0;t="";Ba.init(a);e();try{j();if(g.id==="(number)")k("unexpected_a");else if(g.value.charAt(0)==="<"){a:{var m,o,s,q,B=l.white,r,u,x,A;t="html";T="";for(N=null;;){switch(g.value){case "<":t=
"html";j("<");o={};u=g;u.identifier||f("bad_name_a",u);q=u.value;l.cap&&(q=q.toLowerCase());u.name=q;j();if(!N){N=[];c=q;c!=="html"&&!l.fragment&&(c==="div"&&l.adsafe?k("adsafe_fragment"):k("expected_a_b",n,"html",c));if(l.adsafe){c==="html"&&k("adsafe_html",n);l.fragment?c!=="div"&&k("adsafe_div",n):k("adsafe_fragment",n)}l.browser=true}x=nb[q];typeof x!=="object"&&k("unrecognized_tag_a",u,q);s=x.empty;for(u.type=q;;){if(g.id==="/"){j("/");g.id!==">"&&f("expected_a_b",g,">",g.value);break}if(g.id&&
g.id.charAt(0)===">")break;if(!g.identifier){(g.id==="(end)"||g.id==="(error)")&&f("expected_a_b",g,">",g.value);f("bad_name_a")}l.white=false;I();m=g.value;l.white=B;j();!l.cap&&m!==m.toLowerCase()&&f("attribute_case_a",n);m=m.toLowerCase();T="";Object.prototype.hasOwnProperty.call(o,m)&&f("duplicate_a",n,m);if(m.slice(0,2)==="on"){l.on||f("html_handlers");t="scriptstring";j("=");r=g.id;r!=='"'&&r!=="'"&&k("expected_a_b",g,'"',g.value);T=r;A=l.white;l.white=true;j(r);Ma();qa();l.white=A;g.id!==r&&
k("expected_a_b",g,r,g.value);t="html";T="";j(r);x=false}else if(m==="style"){t="scriptstring";j("=");r=g.id;r!=='"'&&r!=="'"&&k("expected_a_b",g,'"',g.value);t="styleproperty";T=r;j(r);yb();t="html";T="";j(r);x=false}else if(g.id==="="){j("=");x=g.value;!g.identifier&&g.id!=='"'&&g.id!=="'"&&g.id!=="(string)"&&g.id!=="(string)"&&g.id!=="(color)"&&f("expected_attribute_value_a",n,m);j()}else x=true;o[m]=x;c=m;i=x;var v=h=void 0;if(c==="id"){h=typeof i==="string"?i.toUpperCase():"";Xa[h]===true&&f("duplicate_a",
g,i);if(/^[A-Za-z][A-Za-z0-9._:\-]*$/.test(i)){if(l.adsafe)if(X)i.slice(0,X.length)!==X?f("adsafe_prefix_a",g,X):/^[A-Z]+_[A-Z]+$/.test(i)||f("adsafe_bad_id");else{X=i;/^[A-Z]+_$/.test(i)||f("adsafe_bad_id")}}else f("bad_id_a",g,i);v=i.search(Xb);v>=0&&f("unexpected_char_a_b",n,i.charAt(v),c);Xa[h]=true}else if(c==="class"||c==="type"||c==="name"){v=i.search($b);v>=0&&f("unexpected_char_a_b",n,i.charAt(v),c);Xa[h]=true}else if(c==="href"||c==="background"||c==="content"||c==="data"||c.indexOf("src")>=
0||c.indexOf("url")>=0){l.safe&&xb.test(i)&&k("bad_url",g,i);Ga.push(i)}else c==="for"?l.adsafe&&(X?i.slice(0,X.length)!==X?f("adsafe_prefix_a",g,X):/^[A-Z]+_[A-Z]+$/.test(i)||f("adsafe_bad_id"):f("adsafe_bad_id")):c==="name"&&l.adsafe&&i.indexOf("_")>=0&&f("adsafe_name_a",g,i)}c=q;i=o;h=void 0;var D=nb[c],C=v=void 0;rb=false;D||k(H.unrecognized_tag_a,g,c===c.toLowerCase()?c:c+" (capitalization error)");if(N.length>0){c==="html"&&k("unexpected_a",n,c);if(C=D.parent)C.indexOf(" "+N[N.length-1].name+
...
!la&&f("adsafe_go",this)}else switch(g.id){case "{":case "[":ma=true;hb();break;case "@":case "*":case "#":case ".":case ":":t="style";j();(n.id!=="@"||!g.identifier||g.value!=="charset"||n.line!==1||n.from!==1)&&k("css");j();g.id!=="(string)"&&g.value!=="UTF-8"&&k("css");j();W();Ab();break;default:l.adsafe&&l.fragment&&k("expected_a_b",g,"<div>",g.value);G(1);g.id===";"&&!Ka&&W();Ia=true;h=qa();ob.first=h;JAYLINT.tree=ob;l.adsafe&&(h.length!==1||z(h[0],"id","(")||z(h[0].first,"id",".")||z(h[0].first.first,
"value","ADSAFE")||z(h[0].first.second,"value","lib")||h[0].second.length!==2||h[0].second[0].id!=="(string)"||z(h[0].second[1],"id","function"))&&k("adsafe_lib");h.disrupt&&f("weird_program",U)}w=null;j("(end)")}catch(E){E&&JAYLINT.errors.push({reason:E.message,line:E.line||g.line,character:E.character||g.from},null)}return JAYLINT.errors.length===0};fa.data=function(){var a={functions:[]},b,c,d,e,f,g=[],i=[];if(fa.errors.length)a.errors=fa.errors;if(ma)a.json=true;if(Ga.length>0)a.urls=Ga;b=Object.keys(za).filter(function(a){return a.charAt(0)!==
...
b.param=f["(params)"];b.line=f["(line)"];b["(complexity)"]=f["(complexity)"];a.functions.push(b)}if(i.length>0)a.unused=i;if(g.length>0)a.undef=g;for(e in ra)if(typeof ra[e]==="number"){a.member=ra;break}return a};fa.report=function(a){function b(a,c){var d,e;if(Array.isArray(c)){h.push("<div><i>"+a+"</i> ");c=c.sort().forEach(function(a){if(a!==e){e=a;h.push((d?", ":"")+e);d=true}});h.push("</div>")}else c&&h.push("<div><i>"+a+"</i> "+c+"</div>")}var d=fa.data(),e,f,g,i;f="";var k,h=[];if(d.errors||
...
e.exception);b("Outer",e.outer);b("Global",e.global);b("Label",e.label);b("Complexity",e["(complexity)"])}if(d.member){e=Object.keys(d.member);if(e.length){e=e.sort();f="<br><pre id=properties>/*properties ";i=13;for(g=0;g<e.length;g=g+1){a=e[g];k=Db.test(a)?a:"'"+a.entityify().replace(vb,c)+"'";if(i+k.length>72){h.push(f+"<br>");f="    ";i=1}i=i+(k.length+2);d.member[a]===1&&(k="<i>"+k+"</i>");g<e.length-1&&(k=k+", ");f=f+k}h.push(f+"<br>*/</pre>")}h.push("</div>")}}return h.join("")};fa.jslint=
...
if(b instanceof a.Geography)return"$data.Geography";default:return typeof b}};this.isTypeRegistered=function(a){return typeof a==="function"?d.indexOf(a)>-1:a in b};this.unregisterType=function(){Guard.raise("Unimplemented")};this.getType=function(a){Guard.requireValue("typeOrName",a);if(typeof a==="function")return a;a in b||Guard.raise(new Exception("Unable to resolve type:"+a));return d[b[a]]};this.getName=function(a){var b=this.getType(a),b=d.indexOf(b);b==-1&&Guard.raise("unknown type to request name for: "+
a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return null;case a.Boolean:return false;default:return null}};this.registerType=function(a,e,h){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var i=[];i.push(a);a=i}for(i=0;i<a.length;i++){var z=a[i].split("."),y={};y.shortName=z[z.length-1];y.fullName=a[i];a[i]=y}z=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);
b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(z,e);for(var i=0,G=a.length;i<G;i++){y=a[i];"create"+y.shortName in f?console&&console.warn("warning: short names overlap:"+y.shortName+", Container.create"+y.shortName+" has not been updated"):f["create"+y.shortName]=typeof h==="function"?h:z;var u=d.indexOf(e);if(u==-1){u=d.push(e)-1;c[u]=y.fullName}y.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+y.fullName);b[y.fullName]=u}if(!e.name)e.name=
...
a.Integer);a.Container.registerType("Edm.Time",h);a.Container.mapType(h,a.Integer);a.Container.registerType("Edm.Decimal",f);a.Container.mapType(f,a.Number);a.Container.registerType("Edm.Single",i);a.Container.mapType(i,a.Number);a.Container.registerType("Edm.Double",k);a.Container.mapType(k,a.Number);a.Container.registerType("Edm.Guid",s);a.Container.mapType(s,a.String);a.Container.registerType("Edm.Int16",o);a.Container.mapType(o,a.Integer);a.Container.registerType("Edm.Int32",z);a.Container.mapType(z,
...
o[z];B.kind==$data.MemberTypes.navProperty&&s.push(B)}for(o=0;o<s.length;o++)for(var q=s[o],z=k.Associations[q.name],B=z.ToPropertyName,q=[].concat(i.data[q.name]),m=0;m<q.length;m++){var j=q[m];if(j){var V=j[B],ba=z.FromMultiplicity+z.ToMultiplicity;if(z.FromMultiplicity==="$$unbound")if(j instanceof $data.Array){i.dependentOn=i.dependentOn||[];for(V=0;V<j.length;V++)i.dependentOn.indexOf(j)<0&&j.skipSave!==true&&i.dependentOn.push(j)}else{i.dependentOn=i.dependentOn||[];i.dependentOn.indexOf(j)<
0&&j.skipSave!==true&&i.dependentOn.push(j)}else{switch(ba){case "*0..1":V?V instanceof Array?V.indexOf(i.data)==-1&&V.push(i.data):typeof intellisense==="undefined"&&Guard.raise("Item must be array or subtype of array"):j[B]=[i.data];break;default:V?V!==i.data&&typeof intellisense==="undefined"&&Guard.raise("Integrity check error! Item assigned to another entity!"):j[B]=i.data}switch(ba){case "*0..1":case "0..11":i.dependentOn=i.dependentOn||[];i.dependentOn.indexOf(j)<0&&j.skipSave!==true&&i.dependentOn.push(j)}}if(!j.entityState)j.entityState=
$data.EntityState.Added;h.indexOf(j)==-1&&h.push(j)}}}for(f=0;f<c.length;f++){i=c[f];i.skipSave!==true&&b.push(i)}c=[];for(f=0;f<h.length;f++){var y=h[f];d.some(function(a){return a==y})||b.some(function(a){return a.data==y})||c.push({data:y,entitySet:this.getEntitySetFromElementType(y.getType().name)})}}for(o=0;o<b.length;o++){c=b[o];if(c.dependentOn){h=[];for(f=0;f<c.dependentOn.length;f++)d.indexOf(c.dependentOn[f])<0&&h.push(c.dependentOn[f]);c.dependentOn=h}}var d=null,G=this;if(b.length==0){this.stateManager.trackedEntities.length=
0;e.success(0);return a}c=[];for(f=0;f<b.length;f++){i=b[f];if(i.data.entityState===$data.EntityState.Added)for(o=0;o<i.data.getType().memberDefinitions.getPublicMappedProperties().length;o++){d=i.data.getType().memberDefinitions.getPublicMappedProperties()[o];d.required&&!d.computed&&!i.data[d.name]&&(i.data[d.name]=Container.getDefault(d.dataType))}(i.data.entityState===$data.EntityState.Added||i.data.entityState===$data.EntityState.Modified)&&!i.data.isValid()&&c.push({item:i.data,errors:i.data.ValidationErrors})}if(c.length>
0){e.error(c);return a}for(var c=$data.Access.None,u={},d=[],f=0;f<b.length;f++){o=b[f];h=o.entitySet.elementType.name;d.push(o.entitySet.name);i=this._entitySetReferences[h];if(i.beforeCreate||i.beforeUpdate||i.beforeDelete||this.user&&this.checkPermission){u[h]||(u[h]={});switch(o.data.entityState){case $data.EntityState.Added:c=c|$data.Access.Create;if(i.beforeCreate){if(!u[h].createAll)u[h].createAll=[];u[h].createAll.push(o)}break;case $data.EntityState.Modified:c=c|$data.Access.Update;if(i.beforeUpdate){if(!u[h].modifyAll)u[h].modifyAll=
[];u[h].modifyAll.push(o)}break;case $data.EntityState.Deleted:c=c|$data.Access.Delete;if(i.beforeDelete){if(!u[h].deleteAll)u[h].deleteAll=[];u[h].deleteAll.push(o)}}}}var A=function(a){if(a){Q="async";b.length=0}b.length?G.storageProvider.saveChanges({success:function(){G._postProcessSavedItems(e,b)},error:e.error},b):Q?e.error(new Exception("Cancelled event in "+Q,"CancelEvent")):e.success(0)},Q,x=Object.getOwnPropertyNames(u),f=0,D=["beforeUpdate","beforeDelete","beforeCreate"],I={beforeCreate:"createAll",
beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},C=function(a){if(a){Q="async";b.length=0;A(a)}else{var c=G._entitySetReferences[x[f]],d=D.pop();if(a=u[x[f]][I[d]]){for(var e=[],h=0;h<a.length;h++)e.push(a[h].data);if(!D.length){D=["beforeUpdate","beforeDelete","beforeCreate"];f++}h=c[d].call(G,e);if(typeof h==="function")h.call(G,f<x.length&&!Q?C:A,e);else if(h===false){Q=c.name+"."+d;for(c=0;c<a.length;c++){d=b.indexOf(a[c]);b.splice(d,1)}A()}else f<x.length&&!Q?C():A()}else{if(!D.length){D=["beforeUpdate",
"beforeDelete","beforeCreate"];f++}f<x.length&&!Q?C():A()}}};this.user&&this.checkPermission?this.checkPermission(c,this.user,d,{success:function(){f<x.length?C():A()},error:e.error}):f<x.length?C():A();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);for(var c={},d=this,e=0;e<b.length;e++){var h=b[e],f=h.data.entityState;h.data.entityState=
$data.EntityState.Unchanged;h.data.changedProperties=[];h.physicalData=void 0;var i=h.entitySet.elementType.name,k=d._entitySetReferences[i],s=void 0;switch(f){case $data.EntityState.Added:s="added";break;case $data.EntityState.Deleted:s="deleted";break;case $data.EntityState.Modified:s="updated"}s&&this.raiseEvent(s,h);if(k.afterCreate||k.afterUpdate||k.afterDelete){c[i]||(c[i]={});switch(f){case $data.EntityState.Added:if(k.afterCreate){if(!c[i].createAll)c[i].createAll=[];c[i].createAll.push(h)}break;
case $data.EntityState.Modified:if(k.afterUpdate){if(!c[i].modifyAll)c[i].modifyAll=[];c[i].modifyAll.push(h)}break;case $data.EntityState.Deleted:if(k.afterDelete){if(!c[i].deleteAll)c[i].deleteAll=[];c[i].deleteAll.push(h)}}}}var o=Object.getOwnPropertyNames(c),e=0,d=this,z=["afterUpdate","afterDelete","afterCreate"],B={afterCreate:"createAll",afterDelete:"deleteAll",afterUpdate:"modifyAll"},q=function(){d.trackChanges||d.stateManager.reset();a.success(b.length)},m=function(){var a=d._entitySetReferences[o[e]],
...
a,$data.Entity);b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b;if(a[b.name]!=void 0){var d=new $data.PromiseHandler;callBack=d.createCallback(c);c.success(a[b.name]);return d.getPromise()}var e=true,d=this._storageModel.getStorageModel(a.getType().fullName),h=Container.resolveType(b.dataType);if(h===$data.Array||h.isAssignableTo&&h.isAssignableTo($data.EntitySet)){h=Container.resolveType(b.elementType);e=false}else{for(var f,i=0;i<d.Associations.length;i++){var k=d.Associations[i];
if(k.FromPropertyName==b.name){f=k;break}}f&&f.FromMultiplicity==="0..1"&&f.ToMultiplicity==="1"&&(e=false)}f=d.LogicalType.memberDefinitions.getKeyProperties();if(e===true){e="function (e) { return";i={};for(k=0;k<f.length;k++){var s=f[k];k>0&&(e=e+" &&");e=e+(" e."+s.name+" == this.key"+k);i["key"+k]=a[s.name]}return d.EntitySetReference.map("function (e) { return e."+b.name+" }").single(e+"; }",i,c)}e="function (e) { return";i={};for(k=0;k<f.length;k++){s=f[k];k>0&&(e=e+" &&");e=e+(" e."+b.inverseProperty+
...
$data.RegisteredStorageProviders||[];$data.RegisteredStorageProviders[a]=b},getProvider:function(a){var b=$data.RegisteredStorageProviders[a];b||console.warn("Provider not found: '"+a+"'");return b},isSupported:{get:function(){return true},set:function(){}}});$data.Base.extend("$data.EntityWrapper",{getEntity:function(){Guard.raise("pure object")}});Function.prototype.toServiceOperation=function(a){return new $data.FunctionImport(this,a)};
...
c,a);d=arguments[arguments.length-1];typeof d!=="function"&&(d=void 0);if(b){b=Container.createQueryable(b,c);if(d){c.isTerminated=true;return b._runQuery(d)}return b}e=Container.resolveType(a.returnType);b=Container.createQueryable(this,c);b.defaultType=e;if(e===$data.Queryable){b.defaultType=Container.resolveType(a.elementType);if(d){c.isTerminated=true;return b._runQuery(d)}return b}c.isTerminated=true;return b._runQuery(d)};"undefined"!==typeof jQuery&&jQuery.ajax&&($data.ajax=$data.ajax||jQuery.ajax);
...
$data.Class.define("$data.MetadataLoaderClass",null,null,{load:function(a,b,c){var d={EntityBaseClass:"$data.Entity",ContextBaseClass:"$data.EntityContext",AutoCreateContext:false,DefaultNamespace:("ns"+Math.random()).replace(".","")+a.replace(/[^\w]/g,"_"),ContextInstanceName:"context",EntitySetBaseClass:"$data.EntitySet",CollectionBaseClass:"Array",url:a,user:void 0,password:void 0};$data.typeSystem.extend(d,c||{});if(d.DefaultNamespace&&d.DefaultNamespace.lastIndexOf(".")!==d.DefaultNamespace.length-
