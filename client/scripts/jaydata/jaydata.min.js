...
typeof require!=="undefined"){a=require("node_xslt");require("libxmljs");return a.transform(a.readXsltString(b),a.readXmlString(c),["SerivceUri","'"+e.SerivceUri+"'","EntityBaseClass","'"+e.EntityBaseClass+"'","ContextBaseClass","'"+e.ContextBaseClass+"'","AutoCreateContext","'"+e.AutoCreateContext+"'","ContextInstanceName","'"+e.ContextInstanceName+"'","EntitySetBaseClass","'"+e.EntitySetBaseClass+"'","CollectionBaseClass","'"+e.CollectionBaseClass+"'","DefaultNamespace","'"+e.DefaultNamespace+"'"])}},
_findVersion:function(a){if("getElementsByTagName"in a){var b="http://schemas.microsoft.com/ado/2008/09/edm";(a=a.getElementsByTagName("Schema"))&&(a=a[0]);if(a)a=a.attributes;a&&(a=a.getNamedItem("xmlns"));if(a)b=a.value;return{ns:b,version:this._supportedODataVersions[b]||"unknown"}}if(typeof module!=="undefined"&&typeof require!=="undefined"){require("node_xslt");require("libxmljs");return{ns:"http://schemas.microsoft.com/ado/2008/09/edm",version:"nodejs"}}},_supportedODataVersions:{value:{"http://schemas.microsoft.com/ado/2006/04/edm":"V1",
