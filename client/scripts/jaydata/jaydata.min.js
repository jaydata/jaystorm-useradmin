...
a);return c[b]};this.getDefault=function(b){switch(this.resolveType(b)){case a.Number:return 0;case a.Integer:return 0;case a.String:return null;case a.Boolean:return false;default:return null}};this.registerType=function(a,e,h){if(a){typeof e==="string"&&(e=f.resolveType(e));if(typeof a==="string"){var j=[];j.push(a);a=j}for(j=0;j<a.length;j++){var A=a[j].split("."),y={};y.shortName=A[A.length-1];y.fullName=a[j];a[j]=y}A=function(){var a=arguments,b=f.resolveType(e),c=Object.create(b.prototype);
b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(A,e);for(var j=0,G=a.length;j<G;j++){y=a[j];"create"+y.shortName in f?console&&console.warn("warning: short names overlap:"+y.shortName+", Container.create"+y.shortName+" has not been updated"):f["create"+y.shortName]=typeof h==="function"?h:A;var v=d.indexOf(e);if(v==-1){v=d.push(e)-1;c[v]=y.fullName}y.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+y.fullName);b[y.fullName]=v}if(!e.name)e.name=
...
"."+a.getMilliseconds()}});$data.Geography=function(a,b){if(typeof a==="object"&&Array.isArray(a.coordinates)){this.longitude=a.coordinates[0];this.latitude=a.coordinates[1]}else{this.longitude=a;this.latitude=b}};$data.Container.registerType(["$data.Geography","Geography","geography","geo"],$data.Geography);$data.Geography.prototype.toJSON=function(){return{type:"Point",coordinates:[this.longitude,this.latitude]}};$data.ASTNode=function(){};$data.FunctionASTNode=function(){};
$data.FunctionASTNode.prototype=new $data.ASTNode;$data.ParameterASTNode=function(){};$data.MemberAccessASTNode=function(){};$data.MemberAccessASTNode.prototype=new $data.ASTNode;$data.ConstantASTNode=function(){};$data.ASTParserResult=function(a,b,c){this.success=b!="";this.result=a;this.tree=b;this.errors=c};$data.ASTParser=function(){};
...
$data.Class.define("$data.MetadataLoaderClass",null,null,{load:function(a,b,c){var d={EntityBaseClass:"$data.Entity",ContextBaseClass:"$data.EntityContext",AutoCreateContext:true,DefaultNamespace:("ns"+Math.random()).replace(".","")+a.replace(/[^\w]/g,"_"),ContextInstanceName:"context",EntitySetBaseClass:"$data.EntitySet",CollectionBaseClass:"Array",url:a,user:void 0,password:void 0};$data.typeSystem.extend(d,c||{});if(d.DefaultNamespace&&d.DefaultNamespace.lastIndexOf(".")!==d.DefaultNamespace.length-
