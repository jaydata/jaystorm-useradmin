...
b.apply(c,a);return c};typeof intellisense!=="undefined"&&intellisense.annotate(A,e);for(var j=0,G=a.length;j<G;j++){y=a[j];"create"+y.shortName in f||(f["create"+y.shortName]=typeof h==="function"?h:A);var v=d.indexOf(e);if(v==-1){v=d.push(e)-1;c[v]=y.fullName}y.fullName in b&&console.warn("warning:!!! This typename has already been registered:"+y.fullName);b[y.fullName]=v}if(!e.name)e.name=a[0].shortName}}};b.registerType(["$data.Number","number","float","real","decimal","JayNumber"],a.Number);
b.registerType(["$data.Integer","int","integer","int16","int32","int64","JayInteger"],a.Integer);b.registerType(["$data.String","string","text","character","JayString"],a.String);b.registerType(["$data.Array","array","Array","[]","JayArray"],a.Array,function(){return a.Array.apply(void 0,arguments)});b.registerType(["$data.Date","datetime","date","JayDate"],a.Date);b.registerType(["$data.Boolean","bool","boolean","JayBoolean"],a.Boolean);b.registerType(["$data.Blob","blob","JayBlob"],a.Blob);b.registerType(["$data.Object",
"Object","object","{}","JayObject"],a.Object);b.registerType(["$data.Function","Function","function"],a.Function);b.registerType(["$data.ObjectID","ObjectID","objectId","objectid","ID","Id","id","JayObjectID"],a.ObjectID)})(window);b.$C=function(){Class.define.apply(Class,arguments)};a.Class.ConstructorParameter=ConstructorParameter=a.Class.define("ConstructorParameter",null,null,{constructor:function(a){this.paramIndex=a},paramIndex:{}})})($data,window);
...
writeProperties:function(a,b){for(var c={},d=0,e=b.length;d<e;d++){var h=b[d];c[h.name]=h.createPropertyDescriptor(null,h.value)}Object.defineProperties(a,c)},writeProperty:function(a,b,c){if(b=typeof b==="string"?a.getType().memberDefinitions.getMember(b):b){c=b.createPropertyDescriptor(null,c);Object.defineProperty(a,b.name,c)}}};
$data.Geography=function(a,b){if(typeof a==="object"&&Array.isArray(a.coordinates)){this.longitude=a.coordinates[0];this.latitude=a.coordinates[1]}else{this.longitude=a;this.latitude=b}};$data.Container.registerType(["$data.Geography","Geography","geography","geo"],$data.Geography);$data.Geography.prototype.toJSON=function(){return{type:"Point",coordinates:[this.longitude,this.latitude]}};$data.ASTNode=function(){};$data.FunctionASTNode=function(){};$data.FunctionASTNode.prototype=new $data.ASTNode;
$data.ParameterASTNode=function(){};$data.MemberAccessASTNode=function(){};$data.MemberAccessASTNode.prototype=new $data.ASTNode;$data.ConstantASTNode=function(){};$data.ASTParserResult=function(a,b,c){this.success=b!="";this.result=a;this.tree=b;this.errors=c};$data.ASTParser=function(){};
