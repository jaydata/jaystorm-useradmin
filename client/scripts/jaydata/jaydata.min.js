...
n,n.id)}for(;a<g.lbp;){h();n.led?c=n.led(c):m("expected_operator_a",n,n.id)}}return c}function Ea(a,b){var c=Y[a];if(!c||typeof c!=="object")Y[a]=c={id:a,lbp:b,value:a};return c}function M(a){return Ea(a,0)}function oa(a){a.postscript=true;return a}function ab(a){var b=Ea(a,0);b.from=1;b.thru=1;b.line=0;b.edge=true;b.value=a;return oa(b)}function R(a,b){var c=M(a);c.identifier=c.reserved=true;c.fud=b;return c}function Oa(a,b){R(a,b).labeled=true}function Pa(a,b){R(a,b).disrupt=true}function rb(a){var b=
