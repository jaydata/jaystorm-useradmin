...
$data.YQLConverter={fromDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Number":function(b){return"number"===typeof b?b:parseInt(b)},"$data.Integer":function(b){return"number"===typeof b?b:parseFloat(b)},"$data.String":$data.Container.proxyConverter,"$data.Date":function(b){return new Date("string"===
typeof b?parseInt(b):b)},"$data.Boolean":function(b){return!!b},"$data.Blob":$data.Container.proxyConverter,"$data.Array":function(b){return void 0===b?new $data.Array:b}},toDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,
