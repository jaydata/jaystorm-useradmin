...
b},"$data.Time":function(b){return b?new Date(b):b},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":function(b){return b?$data.Container.convertTo("string"===typeof b?atob(b):b.buffer,$data.Blob):b},"$data.Object":function(b){return void 0===b?new $data.Object:b},"$data.Array":function(b){return void 0===b?new $data.Array:b},"$data.ObjectID":function(b){return b?(new Buffer(b.toString(),"ascii")).toString("base64"):b},"$data.GeographyPoint":function(b){return b?
new $data.GeographyPoint(b):b},"$data.GeographyLineString":function(b){return b?new $data.GeographyLineString(b):b},"$data.GeographyPolygon":function(b){return b?new $data.GeographyPolygon(b):b},"$data.GeographyMultiPoint":function(b){return b?new $data.GeographyMultiPoint(b):b},"$data.GeographyMultiLineString":function(b){return b?new $data.GeographyMultiLineString(b):b},"$data.GeographyMultiPolygon":function(b){return b?new $data.GeographyMultiPolygon(b):b},"$data.GeographyCollection":function(b){return b?
new $data.GeographyCollection(b):b},"$data.GeometryPoint":function(b){return b?new $data.GeometryPoint(b):b},"$data.GeometryLineString":function(b){return b?new $data.GeometryLineString(b):b},"$data.GeometryPolygon":function(b){return b?new $data.GeometryPolygon(b):b},"$data.GeometryMultiPoint":function(b){return b?new $data.GeometryMultiPoint(b):b},"$data.GeometryMultiLineString":function(b){return b?new $data.GeometryMultiLineString(b):b},"$data.GeometryMultiPolygon":function(b){return b?new $data.GeometryMultiPolygon(b):
b},"$data.GeometryCollection":function(b){return b?new $data.GeometryCollection(b):b},"$data.Guid":function(b){return b?$data.parseGuid(b).toString():b}},toDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,
"$data.Date":$data.Container.proxyConverter,"$data.DateTimeOffset":$data.Container.proxyConverter,"$data.Time":function(b){return b?Container.convertTo(b,$data.Time):b},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":$data.Container.proxyConverter,"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.ObjectID":function(b){if(b&&"string"===typeof b)try{return new $data.ObjectID(b)}catch(a){try{return new $data.ObjectID((new Buffer(b,
"base64")).toString("ascii"))}catch(c){return console.log(c),b}}else return b},"$data.GeographyPoint":function(b){return b?b.coordinates:b},"$data.GeographyLineString":$data.Container.proxyConverter,"$data.GeographyPolygon":$data.Container.proxyConverter,"$data.GeographyMultiPoint":$data.Container.proxyConverter,"$data.GeographyMultiLineString":$data.Container.proxyConverter,"$data.GeographyMultiPolygon":$data.Container.proxyConverter,"$data.GeographyCollection":$data.Container.proxyConverter,"$data.GeometryPoint":function(b){return b?
