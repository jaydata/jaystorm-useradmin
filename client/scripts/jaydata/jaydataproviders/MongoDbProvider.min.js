...
{$type:$data.Array,$selector:"json:"+b.FromPropertyName,$item:{$type:$data.ObjectID,$value:function(b,a){return a}}}):$data.typeSystem.extend(a.modelBinderConfig,{$type:b.ToType,$source:b.FromPropertyName})}},_addComplexTypeProperties:function(b,a){var c=this;b.forEach(function(b){a.selectModelBinderProperty(b.FromPropertyName);c._addComplexType(b,a);a.popModelBinderProperty()},this)},VisitComplexTypeExpression:function(b,a){this.Visit(b.source,a);this.Visit(b.selector,a);if("$selector"in a.modelBinderConfig&&
...
default:return!1}return null===b||void 0===b?null:!!b},"$data.Blob":function(b){return b},"$data.Object":function(b){return b},"$data.Array":function(b){return b},"$data.ObjectID":function(b){return b&&"string"===typeof b?new $data.mongoDBDriver.ObjectID.createFromHexString((new Buffer(b,"base64")).toString("ascii")):b},"$data.GeographyPoint":function(b){return b.coordinates},"$data.GeographyLineString":function(b){return b},"$data.GeographyPolygon":function(b){return b},"$data.GeographyMultiPoint":function(b){return b},
"$data.GeographyMultiLineString":function(b){return b},"$data.GeographyMultiPolygon":function(b){return b},"$data.GeographyCollection":function(b){return b},"$data.GeometryPoint":function(b){return b.coordinates},"$data.GeometryLineString":function(b){return b},"$data.GeometryPolygon":function(b){return b},"$data.GeometryMultiPoint":function(b){return b},"$data.GeometryMultiLineString":function(b){return b},"$data.GeometryMultiPolygon":function(b){return b},"$data.GeometryCollection":function(b){return b},
"$data.Guid":function(b){return b?b.value:b}}}}},{isSupported:{get:function(){return!$data.mongoDBDriver?!1:!0},set:function(){}}});$data.storageProviders.mongoDB.mongoDBProvider.isSupported&&$data.StorageProviderBase.registerProvider("mongoDB",$data.storageProviders.mongoDB.mongoDBProvider);try{"undefined"===typeof navigator&&(navigator=window.navigator=require("navigator"))}catch(err){}"undefined"===typeof btoa&&(btoa=window.btoa=function(b){return(new Buffer(b,"ascii")).toString("base64")});
