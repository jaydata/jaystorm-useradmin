...
$data.WebApiConverter={fromDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(a){if(a){if(a instanceof Date)return a;if("/Date("===a.substring(0,6))return new Date(parseInt(a.substr(6)));
-1===a.indexOf("Z")&&!a.match("T.*[+-]")&&(a+="Z");return new Date(a)}return a},"$data.DateTimeOffset":function(a){if(a){if(a instanceof Date)return a;if("/Date("===a.substring(0,6))return new Date(parseInt(a.substr(6)));-1===a.indexOf("Z")&&!a.match("T.*[+-]")&&(a+="Z");return new Date(a)}return a},"$data.Time":function(a){return $data.Container.convertTo(a,$data.Time)},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":function(a){if("string"==
typeof a)try{return $data.Container.convertTo(atob(a),"$data.Blob")}catch(b){return a}else return a},"$data.Object":function(a){return void 0===a?new $data.Object:"string"===typeof a?JSON.parse(a):a},"$data.Array":function(a){return void 0===a?new $data.Array:a instanceof $data.Array?a:JSON.parse(a)},"$data.GeographyPoint":function(a){return a&&"object"===typeof a&&Array.isArray(a.coordinates)?new $data.GeographyPoint(a.coordinates):a},"$data.Guid":function(a){return a?a.toString():a}},toDb:{"$data.Entity":$data.Container.proxyConverter,
"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.ObjectID":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(a){return a?a.toISOString().replace("Z",""):a},"$data.Time":function(a){if(a){var b=
a.toTimeString().split(" ")[0];a.toISOString().indexOf(".")&&(b+="."+("000"+a.getMilliseconds()).slice(-3));return b}return a},"$data.DateTimeOffset":function(a){return a?a.toISOString():a},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":function(a){return a?$data.Blob.toBase64(a):a},"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.GeographyPoint":$data.Container.proxyConverter,"$data.Guid":$data.Container.proxyConverter},
escape:{"$data.Entity":function(a){return JSON.stringify(a)},"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":function(a){return a?a+"m":a},"$data.Float":function(a){return a?a+"f":a},"$data.Int64":function(a){return a?a+"L":a},"$data.Time":function(a){return a?"time'"+a+"'":a},"$data.DateTimeOffset":function(a){return a?
"datetimeoffset'"+a+"'":a},"$data.Date":function(a){return a?"datetime'"+a+"'":a},"$data.String":function(a){return"string"===typeof a?"'"+a.replace(/'/g,"''")+"'":a},"$data.ObjectID":function(a){return"string"===typeof a?"'"+a.replace(/'/g,"''")+"'":a},"$data.Boolean":function(a){return"boolean"===typeof a?a.toString():a},"$data.Blob":function(a){return a?"X'"+$data.Blob.toHexString($data.Container.convertTo(atob(a),$data.Blob))+"'":a},"$data.Object":function(a){return JSON.stringify(a)},"$data.Array":function(a){return JSON.stringify(a)},
"$data.GeographyPoint":function(a){return a?$data.GeographyBase.stringifyToUrl(a):a},"$data.Guid":function(a){return a?"guid'"+a.toString()+"'":a}}};
...
b.error(arguments)}};this.appendBasicAuth(d,this.providerConfiguration.user,this.providerConfiguration.password,this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,d);$data.ajax(d)},_compile:function(a){return(new $data.storageProviders.webApi.webApiCompiler).compile(a)},saveChanges:function(a,b){0<b.length?this.saveInternal(this.buildIndependentBlocks(b),0,a):a.success(0)},saveInternal:function(a,b,c){1<a.length||1==a.length&&1<a[0].length?this._saveBatch(a,b,c):this._saveRest(a,
b,c)},_saveRest:function(a,b,c){for(var e=[],d,b=0;b<a.length;b++)for(var g=0;g<a[b].length;g++){e.push(a[b][g].data);d={url:this.providerConfiguration.apiUrl+"/",headers:{},contentType:"application/json",dataType:"json"};switch(a[b][g].data.entityState){case $data.EntityState.Unchanged:continue;case $data.EntityState.Added:d.type="POST";d.url+=a[b][g].entitySet.tableName;d.data=this.save_getInitData(a[b][g],e);break;case $data.EntityState.Modified:d.type="PUT";d.url+=a[b][g].entitySet.tableName;
d.url+="/"+this.getEntityKeysValue(a[b][g]);this.save_addConcurrencyHeader(a[b][g],d.headers);d.data=this.save_getInitData(a[b][g],e);break;case $data.EntityState.Deleted:d.type="DELETE";d.url+=a[b][g].entitySet.tableName;d.url+="/"+this.getEntityKeysValue(a[b][g]);this.save_addConcurrencyHeader(a[b][g],d.headers);break;default:Guard.raise(new Exception("Not supported Entity state"))}d.data&&(d.data=JSON.stringify(d.data))}var f=this;d.success=function(a,b,d){b=d.status;if(200<=b&&300>b){if(a){var g=
e[0];g.getType().memberDefinitions.getPublicMappedProperties().forEach(function(b){var c=Container.resolveType(b.type);if(b.computed||b.key||!c.isAssignableTo&&!b.inverseProperty)c=f.fieldConverter.fromDb[Container.resolveName(b.type)],g[b.name]=c?c(a[b.name]):a[b.name]},this)}c.success&&c.success(e.length)}else c.error(response)};d.error=function(a){c.error(new Exception((a.response||{}).body,a.message,a))};this.appendBasicAuth(d,this.providerConfiguration.user,this.providerConfiguration.password,
this.providerConfiguration.withCredentials);this.context.prepareRequest.call(this,d);$data.ajax(d)},_saveBatch:function(a,b,c){for(var b=[],e=[],d=0;d<a.length;d++)for(var g=0;g<a[d].length;g++){e.push(a[d][g].data);var f={};f.headers={"Content-Id":e.length};switch(a[d][g].data.entityState){case $data.EntityState.Unchanged:continue;case $data.EntityState.Added:f.method="POST";f.requestUri=a[d][g].entitySet.tableName;f.data=this.save_getInitData(a[d][g],e);break;case $data.EntityState.Modified:f.method=
"MERGE";f.requestUri=a[d][g].entitySet.tableName;f.requestUri+="("+this.getEntityKeysValue(a[d][g])+")";this.save_addConcurrencyHeader(a[d][g],f.headers);f.data=this.save_getInitData(a[d][g],e);break;case $data.EntityState.Deleted:f.method="DELETE";f.requestUri=a[d][g].entitySet.tableName;f.requestUri+="("+this.getEntityKeysValue(a[d][g])+")";this.save_addConcurrencyHeader(a[d][g],f.headers);break;default:Guard.raise(new Exception("Not supported Entity state"))}b.push(f)}var h=this,a=[{requestUri:this.providerConfiguration.apiUrl+
"/$batch",method:"POST",data:{__batchRequests:[{__changeRequests:b}]}},function(a,b){if(202==b.statusCode){for(var d=a.__batchResponses[0].__changeResponses,g=[],f=0;f<d.length;f++)if(200<d[f].statusCode&&300>d[f].statusCode){var j=e[f];if(204==d[f].statusCode){if(d[f].headers.ETag||d[f].headers.Etag||d[f].headers.etag){var l=j.getType().memberDefinitions.getPublicMappedProperties().filter(function(a){return a.concurrencyMode===$data.ConcurrencyMode.Fixed});l&&l[0]&&(j[l[0].name]=d[f].headers.ETag||
d[f].headers.Etag||d[f].headers.etag)}}else j.getType().memberDefinitions.getPublicMappedProperties().forEach(function(a){if(a.computed||a.key)if(a.concurrencyMode===$data.ConcurrencyMode.Fixed)j[a.name]=d[f].headers.ETag||d[f].headers.Etag||d[f].headers.etag;else{var b=h.fieldConverter.fromDb[Container.resolveType(a.type)];j[a.name]=b?b(d[f].data[a.name]):d[f].data[a.name]}},this)}else g.push(new Exception((d[f].response||{}).body,d[f].message,d[f]));0<g.length?c.error(new Exception("See inner exceptions",
...
return a},supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Object,$data.GeographyPoint,$data.Guid,$data.Byte,$data.SByte,$data.Decimal,$data.Float,$data.Int16,$data.Int64,$data.Time,$data.DateTimeOffset],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:"eq",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},notEqual:{mapTo:"ne",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,
